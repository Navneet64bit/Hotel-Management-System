...
public class Checkout extends JFrame implements ActionListener{
    ...
    Checkout(){
        ...
        JLabel text = new JLabel("Chechout");
        ...
        lblcheckintime.setBounds(160 , 180, 150, 30);
        add(lblcheckintime);
        ...
        lblcheckouttime.setBounds(160 , 230, 150, 30);
        add(lblcheckouttime);
    ...
    public void actionPerformed (ActionEvent ae) {
        if(ae.getSource() == checkout) {
            ...
            String query2 = "upadate room set availability = 'Available' where roomnumber = '"+lblroomnumber.getText()+"'";
            
            try{
                Conn c = new Conn();
                //(for ref.)c.s.executeUpdate("update room set availability = '"+available+"',cleaning_status = '"+status+"' where roomnumber = '"+room+"'");
