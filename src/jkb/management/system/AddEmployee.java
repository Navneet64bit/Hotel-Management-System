...
public class AddEmployee extends JFrame implements ActionListener
{
    ...
    AddEmployee()
    {
        ...
        String str[] = { "Front Desk Clerks", "Porters", "Housekeeping", "Kitchen Staff","Room Service","cheifs","Waiters","Manager"};
...
//        }
        ...
        try{
            ...
            String query = "insert into employee values('"+name+"','"+age+"','"+gender+"','"+job+"','"+salary+"','"+phone+"' ,'"+email+"','"+aadhar+"' )"; //dml
